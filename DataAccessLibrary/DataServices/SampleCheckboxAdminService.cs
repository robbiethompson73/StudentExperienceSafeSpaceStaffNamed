...
{
    public class SampleCheckboxAdminService : ISampleCheckboxAdminService
    {

        private readonly IDataAccess _dataAccess;
        private readonly ConnectionStringData _connectionStringData;

        public SampleCheckboxAdminService(IDataAccess dataAccess, ConnectionStringData connectionStringData)
        {
        ...
        public async Task<int> CreateAsync(SampleCheckboxAdminEntityModel entityModel)
        {
            ...
            await _dataAccess.SaveDataAsync<dynamic>("dbo.spSampleCheckboxAdmin_Insert", p, _connectionStringData.SqlConnectionName);
        ...
        public async Task<int> UpdateAsync(SampleCheckboxAdminEntityModel entityModel)
        {
            // Update the submission record
            await _dataAccess.SaveDataAsync<dynamic>(
                "dbo.spSampleCheckboxAdmin_Update",
                new
                {
                    Id = entityModel.Id,
        ...
        public async Task<List<SelectListItem>> GetAllSelectListAsync()
        {
            var rows = await _dataAccess.LoadDataAsync<SampleCheckboxEntityModel, dynamic>(
                            "dbo.spSampleCheckboxAdmin_GetAll",
                            new { },
                            _connectionStringData.SqlConnectionName);
        ...
        {
            var rows = await _dataAccess.LoadDataAsync<SampleCheckboxAdminEntityModel, dynamic>(
                            "dbo.spSampleCheckboxAdmin_GetAllActive",
                            new { },
                            _connectionStringData.SqlConnectionName);
        ...
        public async Task<string> GetTitleById(int id)
        {
            ...
            var rows = await _dataAccess.LoadDataAsync<string, dynamic>(
                            "dbo.spSampleCheckboxAdmin_GetTitleById",
                            parameters,
                            _connectionStringData.SqlConnectionName);
