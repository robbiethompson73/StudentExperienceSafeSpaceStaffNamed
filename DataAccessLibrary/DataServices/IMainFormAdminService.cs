...
namespace DataAccessLibrary.DataServices
{
    ...
    {
        Task<(List<MainFormAdminEntityModel> Items, int TotalCount)> GetAllOrByFilterAsync(string? studentReferenceNumber, int? statusId, string? sortBy, string? sortDirection, int? pageNumber, int? pageSize);
